...
public class ReceiptController {
    ...
    @FXML
    private TableColumn<Receipt, BigDecimal> totalCostColumn; // Добавим столбец для totalCost
    ...
    private void initialize() {
        ...
        totalCostColumn.setCellValueFactory(new PropertyValueFactory<>("totalCost")); // Привязываем totalCost
    ...
    // Метод для пометки квитанции как оплаченной
    @FXML
