...
class Fox(Animal):
    def __init__(self, age=8, size=1, hunger=80, sex=None):
        super().__init__(age, size, hunger, sex)
...
class Bear(Animal):
    def __init__(self, age=15, size=3, hunger=100, sex=None):
        super().__init__(age, size, hunger, sex)
...
class Deer(Animal):
    def __init__(self, age=15, size=3, hunger=60, sex=None):
        super().__init__(age, size, hunger, sex)
