...
*/
variableDeclaration
    : VAR type QUESTION ID ASSIGN expression SEMICOLON
    ;
...
lambdaAssignment
    : VAR FUNCTION_TYPE QUESTION ID ASSIGN lambdaExpression SEMICOLON
    ;
...
lambdaExpression
    : LPAREN (parameter (COMMA parameter)*)? RPAREN ARROW lambdaBody
    | parameter ARROW lambdaBody
    ;
